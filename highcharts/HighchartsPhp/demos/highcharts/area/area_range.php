...
chdir('/home/asmirnov/workspace/pbr-wifc-btp/shcc/');

require_once "highcharts/HighchartsPhp/src/Highchart.php";
require_once "highcharts/HighchartsPhp/src/HighchartJsExpr.php";
